...
class Reservations extends Controller {
	...
	public function reservations() {
		...
		$data['diff_apartments'] = $this->_reservations->get_diff_apartments($id_user);
	...
	public function edit($reservation_id) {
	    ...
	    $data['guests'] = $this->_guests->get_guests($data['user_data'][0]->id_user);  
		$data['apartments'] = $this->_apartments->get_apartments($data['user_data'][0]->id_user);
