                   ...
                   <div class="col-md-12    ">
                      <div class="panel panel-default">
                         <div class="panel-heading">
                                      <h3 class="panel-title">Uređivanje profila: <?php echo $data['row'][0]->ime;?> <?php echo $data['row'][0]->prezime;?></h3> 
                          </div>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                      <label class="col-sm-3 control-label">Ime: </label>
                                        <div class="col-sm-6">
                                          <input type="text" class="form-control" name="ime" placeholder="Ime..." value='<?php echo $data['row'][0]->ime;?>'>
                                        </div>
                                  </div>  
                                  <div class="form-group">
                                      <label class="col-sm-3 control-label">Prezime: </label>
                                        <div class="col-sm-6">
                                          <input type="text" class="form-control" name="prezime" placeholder="Prezime..." value='<?php echo $data['row'][0]->prezime;?>'>
                                        </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-3 control-label">Mjesto: </label>
                                        <div class="col-sm-6">
                                          <input type="text" class="form-control" name="mjesto" placeholder="Mjesto..." value='<?php echo $data['row'][0]->mjesto;?>'>
                                        </div>
                                  </div>
                                    <div class="form-group">
                                      <label class="col-sm-3 control-label">Korisničko ime: </label>
                                        <div class="col-sm-6">
                                          <input type="text" class="form-control" name="username" placeholder="Korisničko ime..." value='<?php echo $data['row'][0]->username;?>'>
                                        </div>
                                  </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-3 control-label">Email: </label>
                                        <div class="col-sm-6">
                                          <input type="text" class="form-control" name="email" placeholder="Email..." value='<?php echo $data['row'][0]->email;?>'>
                                        </div>
                                  </div>
                                 <div class="form-group">
